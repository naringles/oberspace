...
const folderTypeAssign = async (file) => {
  try {
    ...
    if (typeof file !== undefined) {
      ...
      if (typeof extension !== "undefined" && extension.includes("exe"))
        extension = "exe";
      if (typeof extensionMappings[extension] !== "undefined")
        return extensionMappings[extension];
      else if (typeof mimeSuffixMappings[mimeSuff] !== "undefined")
        return mimeSuffixMappings[mimeSuff];
      else if (typeof mimePrefixMappings[mimePref] !== "undefined")
        return mimePrefixMappings[mimePref];
      else return "Others";
    }
  } catch (err) {
